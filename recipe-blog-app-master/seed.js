...
Source: https://www.jamieoliver.com/recipes/vegetables-recipes/stir-fried-vegetables/`,
  ...
  },
  {
    ...
    description: `A fermented crepe made from rice batter and black lentils, stuffed with a delicious, spiced potato mash. Crispy on the outside and soft on the inside, it is traditionally served hot with fresh coconut chutney and savory sambar broth.`,
    email: "hello@email.com",
    ingredients: [
  ...
  },
  {
    ...
    description: `The iconic Spanish omelette made with thinly sliced potatoes and onions slowly cooked in olive oil before being mixed with beaten eggs and pan-fried to a soft, custardy perfection. It can be served warm or at room temperature as a tapa or a light meal.`,
    email: "hello@email.com",
    ingredients: [
      "6 large eggs",
      "4 large potatoes",
...
async function seed() {
  try {
    const mongoUri = process.env.MONGO_URI || "mongodb://localhost:27017/recipe_blog";
    ...
    console.log("Successfully inserted recipes!");
